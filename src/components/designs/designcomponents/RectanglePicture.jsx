    ...
    >
      ...
      {( url_type === "logo" && (userData.logo === null || userData.logo === "" )) ? [
        ...
        <DesignImageTrabed key="a" src={processur()} alt={`${Alt}`}
          className={`bg-fixed rounded-lg ${selfStyle}`}
                ...
                {(url_type !== "editable") ? [
                  ...
                  <div key="a" className='flex flex-row '>
                    <div className='flex flex-col w-full'>
                      ...
                      <label key='fbc' htmlFor="logo" className='flex flex-row justify-center bg-blue-300 cursor-pointer p-4 mb-5'>Upload</label>
