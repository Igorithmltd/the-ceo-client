...
const TextContainer = props => {
  ...
  return (
    ...
    >
      <p key="a" className={`bg-transparent ${selfStyle}`}
        style={{rotate:`${props.degree}deg`,opacity:`${props.opacity}%`, fontSize: `${iheight}px`, color: `${SelfColorCode}`, 
        ...
        <Box className="w-11/12">
          <Stack sx={sty} className="flex flex-col " >
            <div className='flex flex-col w-full'>
              ...
              <Stack key="i" className="flex flex-row bg-transparent w-full">
