...
const SuccessExpensesModal = () => {
  ...
  return (
    <Modal isOpen={isSuccessExpensesOpen} closeModal={closeModal} >
      <div className="absolute md:relative m-auto bottom-0 md:bottom-auto
        ...
        <div className="flex justify-center items-center">
            <span className="font-bold text-center">Your expenses has been successfully added!</span> 
        </div>
...
export default SuccessExpensesModal;
