...
const EditServiceModal = () => {
  ...
  return (
    <Modal isOpen={isEditServiceOpen} closeModal={closeModal}>
      <div className="bg-white md:w-[80vw] w-full h-[80vh] overflow-auto p-6">
        <div className="flex py-5 items-center justify-between md:px-8">
